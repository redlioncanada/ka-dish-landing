System.register(['angular2/core', './landing.video-player.selector', './landing.video-player.player', './services/logger.service', './services/appdata.service', './services/breakpoint.service'], function(exports_1, context_1) {
    "use strict";
